...
public class BookingController {
    ...
    private Set<BookingDTO> getBookingDTOs(List<Booking> bookings){
        return bookings.stream()
                .map(booking -> {
                    ...
                    UserDTO user;
                    try {
                        salon  = salonFeignClient.getSalonsById(booking.getSalonId()).getBody();
    ...
    public ResponseEntity<BookingDTO> getBookingById(
        ...
        SalonDTO salon  = salonFeignClient.getSalonsById(booking.getSalonId()).getBody();
        return ResponseEntity.ok(BookingMapper.toDTO(booking, services,salon, user));
    }
